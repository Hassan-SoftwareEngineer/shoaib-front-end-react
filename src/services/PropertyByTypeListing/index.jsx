...
const PropertyByTypeListing = () => {
  ...
  return (
    <>
      <Navbar />
      <Box sx={{ width: "90%", mx: "auto", mt: { md: "60px" } }}>
        <Box
          sx={{
            height: "270px",
            position: "relative",
        ...
        >
          ...
          <span className="become-host">
            ...
            >
              <TVHeading sx={{ color: "#fff" }}>Properties List</TVHeading>
              <Grid container sx={{ background: "#fff", borderRadius: "8px" }}>
                ...
                >
                  <SearchBox
                    ...
                    onRetrieve={(val) => {
                      setLocation({
                        lat: val?.features[0]?.properties?.coordinates
                          ?.latitude,
                        lng: val?.features[0]?.properties?.coordinates
                          ?.longitude,
                      });
                    }}
                  />
...
export default PropertyByTypeListing;
