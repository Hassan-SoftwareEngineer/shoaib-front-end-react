...
import rentImage from "../../assets/images/home/6.png";
  ...
  return (
    <Box sx={{ my: {xs:"3rem",md:"6rem",lg:"10rem"} }}>
      ...
      <Grid item xs={12} sm={12} md={6} lg={7}>
          ...
          <TVHeading sx={{mt:{xs:"0px",md:"20px",lg:"26px"},mb:{xs:"20px",md:"40px",lg:"60px"}}}>Become a Host</TVHeading>
          ...
          <Box sx={{display:"flex",justifyContent:"center",alignItems:"center",mt:"3rem"}}>
            <MDButtonPrimary onClick={()=> isLogIn ? navigate("/hostplan") : navigate('/signin')}>Become a Host</MDButtonPrimary>
          </Box>
        </Grid>
        <Grid item xs={12} sm={12} md={6} lg={5}>
          <div className="rent-sec-img rent-sec-img-2" >
