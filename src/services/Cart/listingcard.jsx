...
import { AddToCart } from "../../redux/listingPoperty/listingSlice";
...
const handleAddToCart = (item) => {
    ...
    return (
        <Box sx={{mb:4,maxWidth:"700px",borderRadius:{xs:"8px",lg:"0px"},overflow:"hidden",border:{xs:"1px solid #00E4FE",md:"none"}}}>
            <Grid container>
                ...
                <Grid item xs={12} sm={12} md={6} lg={7}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Box>
                            <MDButtonPrimary sx={{px:"10px!important",fontSize:"12px!important"}} onClick={(e)=>{e.stopPropagation();handleAddToCart(props?.Data)}}>Remove from Cart</MDButtonPrimary>
                            </Box>
