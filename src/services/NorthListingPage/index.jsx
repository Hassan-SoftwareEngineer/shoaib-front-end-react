...
const NorthListing = () => {
  ...
  const AllData = Array.isArray(NorthAmerica?.data?.response?.data) &&  NorthAmerica?.data?.response?.data || [];
  ...
  return (
    <>
      ...
      <Box sx={{ width: "100%", mx: "auto", mt: { md: "60px" } }}>
        ...
        >
          ...
          <span className="become-host">
            ...
            >
              <TVHeading sx={{ color: "#fff" }}>North America</TVHeading>
      ...
      <Box sx={{ width: "90%", mx: "auto"}}>
        ...
        <Box sx={{border:"1px solid #FE4080",borderRadius:"8px",px:2,py:1,mb:3}}>
          <Filters/>
        </Box>
          </Grid>
